...
\begin{figure}[htbp]
  \begin{minipage}{\hsize}
    \begin{center}
      \fbox{\includegraphics[width=120mm]{image/weather_widget.eps}}
    \end{center}
...
\begin{figure}[htbp]
  \begin{minipage}{\hsize}
    \begin{center}
      \fbox{\includegraphics[width=120mm]{image/odakyu_widget.eps}}
    \end{center}
...
\begin{figure}[htbp]
  \begin{minipage}{\hsize}
    \begin{center}
      \fbox{\includegraphics[width=120mm]{image/odakyu.eps}}
    \end{center}
...
\begin{figure}[htbp]
  \begin{minipage}{\hsize}
    \begin{center}
      \fbox{\includegraphics[width=120mm]{image/sensor_widget.eps}}
    \end{center}
...
\begin{figure}[htbp]
  \begin{minipage}{\hsize}
    \begin{center}
      \fbox{\includegraphics[width=120mm]{image/arduino_sensor.eps}}
    \end{center}
...
%\begin{figure}[htbp]
  \begin{minipage}{\hsize}
    \begin{center}
      \fbox{\includegraphics[width=80mm]{image/widget_single.eps}}
    \end{center}
